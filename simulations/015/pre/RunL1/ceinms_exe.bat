...
rem Set CEINMS_EXE_DIR to two directories up plus ceinms\executables
set "CEINMS_EXE_DIR=%SCRIPT_DIR%..\..\..\..\..\ceinms\executables"

rem Paths to CEINMS calibration executable and setup file
set "CEINMS_EXE=%CEINMS_EXE_DIR%\CEINMS.exe"
set "SETUP_XML=%SCRIPT_DIR%setup_ceinms.xml"
